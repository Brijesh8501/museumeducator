                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <form role="form" method="post" onsubmit='return checkQuotee(this)'>
                                        <div class="form-group">
                                            <label>City ID :</label>
                                            <input class="form-control" name="ct_id" />
                                            <div class="help-block">Help text here.</div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Name :</label>
                                            <input class="form-control" name="ct_name" />
                                            <div class="help-block">Help text here.</div>
                                        </div>
                                        <div class="form-group">
                                            <label>State :</label>
                              ...
                              <option value="<?php echo $st->st_id ?>"><?php echo $st->st_name; ?></option>
                                        ...
                                        <button type="submit" class="btn btn-default" name="city_submit">Submit Button</button>
