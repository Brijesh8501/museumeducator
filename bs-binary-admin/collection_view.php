                                ...
                                <div class="col-md-4">
                                    ...
                                    <form role="form" method="post" onsubmit='return checkQuotee(this)'>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="collection_id" />
                                            <div class="help-block"></div>
                                        </div>
                                        <div class="form-group">
                                            <label>Collection Type:</label>
                                            <input class="form-control" name="collection_type" />
                                            <div class="help-block"></div>
                                        </div>
                                        <div class="form-group">
                                            <label>Collection Name :</label>
                                            <input class="form-control" name="collection_name" />
                                            <div class="help-block"></div>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-default" name="co_submit">Submit Button</button>
